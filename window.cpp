...
QCViewer::QCViewer() : m_button1("Button 1"), m_button2("Button 2") {
  ...
  m_refActionGroup->add(Gtk::Action::create("FileSaveImage", "_Diagram", "Save the circuit diagram to an image file"));
  ...
  m_refActionGroup->add(Gtk::Action::create("FileSaveArchitecture", "_Architecture", "Save architecture"),
	                      sigc::mem_fun(*this, &QCViewer::unimplemented));
	m_refActionGroup->add(Gtk::Action::create("FileSaveImagePng", "P_NG", "Save circuit diagram as a Portable Network Graphics file"),
	                      sigc::mem_fun(*this, &QCViewer::on_menu_save_png));
	m_refActionGroup->add(Gtk::Action::create("FileSaveImageSvg", "S_VG", "Save circuit diagram as a Scalable Vector Graphics file"),
	                      sigc::mem_fun(*this, &QCViewer::unimplemented));
...
//  m_cmdIn.show ();
  ...
  show_all_children ();
	c.set_offset (50 + m_vbox.get_height ()); // this is incorrect. what is the solution?
